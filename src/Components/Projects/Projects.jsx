  ...
  return (
    <div className='projects'>
        ...
        <div className="proj-grid">
            {/*First Project*/}
            <div className="gridItem" data-aos='fade-right'><img className='projImg'src='src/assets/workwiz-home.png'/></div>
            <div className="gridItem" data-aos='fade-right'><h1 className='proj1-header'>Work Wizard - Employee Dashboard</h1>
            ...
            {/*Second Project*/}
            <div className="gridItem" data-aos='fade-left'><h1 className='proj1-header'>Meridian Tattoo Supply</h1>
            ...
            <div className="gridItem" data-aos='fade-left'><img className='projImg' src='src/assets/tattooSupply.png'/></div>

            {/*Third Project*/}
            <div className="gridItem" data-aos='fade-right'><img className='projImg' src='src/assets/world-map.png'/></div>
            <div className="gridItem" data-aos='fade-right'><h1 className='proj1-header'>World Map</h1>
