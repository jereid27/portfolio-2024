  ...
  return (
    <div className='about' id='about'>
        ...
        <div className="marquee">
            <div className="marquee__inner-wrap">
                <div className="marquee__inner">
                    ...
                    <div className='marquee__img'><img src='public/star-img.webp' alt='star'/></div>
                    ...
                    <div aria-hidden="true" className='marquee__img'><img src='public/star-img.webp' alt='star'/></div>
                    ...
                    <div aria-hidden="true" className='marquee__img'><img src='public/star-img.webp' alt='star'/></div>
                    <span aria-hidden="true">TEAM PLAYER</span>
                    <div aria-hidden="true" className='marquee__img'><img src='public/star-img.webp' alt='star'/></div>
                    <span aria-hidden="true">CAT DAD</span>
                    <div aria-hidden="true" className='marquee__img'><img src='public/star-img.webp' alt='star'/></div>
                    <span aria-hidden="true">DEDICATED</span>
                    <div aria-hidden="true" className='marquee__img'><img src='public/star-img.webp' alt='star'/></div>
                </div>
            </div>
        </div>
        ...
        <div className="container">
            ...
            <img className='profile-pic' src='public/profile-pic.jpg' alt='profile picture'/>
            </div>
